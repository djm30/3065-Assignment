...
describe("Should calculate the marks required to get the next grade", () => {
    ...
    test("Average between 60 & 70 should return appropiate amount of marks needed for a first", () => {
        ...
        expect(result).toBe(
            "Your current average is: 61, and is 9 marks from a First, you need a total of 45 more marks across all 5 possible modules to reach this.",
        );
    });
    ...
    test("Average between 50 & 60 should return appropiate amount of marks needed for a 2.1", () => {
        ...
        expect(result).toBe(
            "Your current average is: 51, and is 9 marks from a 2.1, you need a total of 45 more marks across all 5 possible modules to reach this.",
        );
    });
    ...
    test("Average between 40 & 50 should return appropiate amount of marks needed for a 2.2", () => {
        ...
        expect(result).toBe(
            "Your current average is: 41, and is 9 marks from a 2.2, you need a total of 45 more marks across all 5 possible modules to reach this.",
        );
    });
    ...
    test("Average below 40 should return appropiate amount of marks needed for a third", () => {
        ...
        expect(result).toBe(
            "Your current average is: 31, and is 9 marks from a Third, you need a total of 45 more marks across all 5 possible modules to reach this.",
        );
    });
    ...
    test("Average of 0 should return appropiate amount of marks needed for a third", () => {
        ...
        expect(result).toBe(
            "Your current average is: 0, and is 40 marks from a Third, you need a total of 200 more marks across all 5 possible modules to reach this.",
        );
    });
    ...
    test("Works with undefined values in the marks array", () => {
        ...
        expect(result).toBe(
            "Your current average is: 64, and is 6 marks from a First, you need a total of 30 more marks across all 5 possible modules to reach this.",
        );
    });
});
