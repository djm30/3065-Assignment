...
class TestMaxMinAPITest extends TestCase
{
    private $http;
    ...
    public function api_returns_200_with_valid_params()
    {
        ...
        $this->assertEquals("Two - 72", $responseData["max_module"]);
        $this->assertEquals("Five - 60", $responseData["min_module"]);
    }
    ...
    public function api_returns_400_with_invalid_params()
    {
        ...
        $this->assertEquals("", $responseData["max_module"]);
        $this->assertEquals("", $responseData["min_module"]);
    }
}
...
class TestHealthCheckAPI extends TestCase
{
    ...
    protected function setUp(): void
    {
        $this->http = new Client(["base_uri" => "http://localhost:9002/health.php"]);
    }
